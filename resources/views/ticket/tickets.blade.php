                ...
                @foreach ($tickets as $ticket)
                    <div class="col-12 col-md-3">
                        <div class="card mb-3" style="width: 18rem;">
                            <img src="{{$ticket['img']}}" class="card-img-top card-img" alt="San Siro Settori">
                            <div class="card-body">
                                <h5 class="card-title">Settore {{$ticket['settore']}}</h5>
                                <p class="card-text">Posto {{$ticket['posto']}}</p>
                                <a href="{{route('ticket.detail', ['id'=>$ticket['id']])}}" class="btn btn-primary">Leggi di piu'</a>
                            </div>
                        </div>
                    </div>
                @endforeach
